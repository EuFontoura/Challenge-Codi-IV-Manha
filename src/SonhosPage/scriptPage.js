...
function preencher_div_botoes() {
    ...
    listaDeSonhos.forEach(sonho => {
        const divBotoes = ['div', { 'class': 'dream', 'id': sonho.chave_objeto }, [
            ['h3', { 'id': 'dreamTitle' }, sonho.objetivo],
...
function fechar_formulario(formSelected) {
    ...
    document.querySelector(formSelected).style.animation = "arrasteSaida 1s"
    document.querySelector(".overlay").style.animation = "arrasteSaidaOverlay 1s"
        ...
        setTimeout(() => {
            ...
            document.querySelector(formSelected).style.animation = "arraste 0.7s"
